...
// Register all tests
REGISTER_MINI_TEST!("Knot", "Knot Count", crate::knot_test::run_knot_count);
...
REGISTER_MINI_TEST!("Knot", "Is Valid", crate::knot_test::run_is_valid);
REGISTER_MINI_TEST!("Knot", "Is Clamped", crate::knot_test::run_is_clamped);
REGISTER_MINI_TEST!("Knot", "Is Periodic", crate::knot_test::run_is_periodic);
REGISTER_MINI_TEST!("Knot", "Get Domain", crate::knot_test::run_get_domain);
REGISTER_MINI_TEST!("Knot", "Set Domain", crate::knot_test::run_set_domain);
...
REGISTER_MINI_TEST!("Knot", "Span Count", crate::knot_test::run_span_count);
REGISTER_MINI_TEST!("Knot", "Find Span", crate::knot_test::run_find_span);
REGISTER_MINI_TEST!("Knot", "Greville Abcissae", crate::knot_test::run_greville_abcissae);
REGISTER_MINI_TEST!("Knot", "Domain Tolerance", crate::knot_test::run_domain_tolerance);
