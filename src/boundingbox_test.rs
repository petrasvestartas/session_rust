...
pub fn run_boundingbox_constructor() -> TestResult {
    MINI_TEST!("Constructor", {
        ...
        // from_point
        let mut bb1 = BoundingBox::from_point(Point::new(5.0, 5.0, 5.0), 2.0);
        ...
        let bb2 = BoundingBox::from_points(&pts, 0.0);
        ...
        // inflate
        let mut bb3 = BoundingBox::from_points(&[Point::new(0.0, 0.0, 0.0), Point::new(2.0, 2.0, 2.0)], 0.0);
        bb3.inflate(1.0);
...
pub fn run_boundingbox_collision() -> TestResult {
    MINI_TEST!("Collision", {
        use crate::BoundingBox;
        use crate::Point;

        let bb1 = BoundingBox::from_point(Point::new(0.0, 0.0, 0.0), 1.0);
        let bb2 = BoundingBox::from_point(Point::new(1.5, 0.0, 0.0), 1.0);
        let bb3 = BoundingBox::from_point(Point::new(5.0, 5.0, 5.0), 0.5);
...
pub fn run_boundingbox_transformation() -> TestResult {
    MINI_TEST!("Transformation", {
        ...
        let mut bb = BoundingBox::from_points(&pts, 0.0);
...
pub fn run_boundingbox_protobuf_roundtrip() -> TestResult {
    MINI_TEST!("Protobuf Roundtrip", {
        ...
        // Bytes
        let b = bb.pb_dumps();
        let loaded_s = BoundingBox::pb_loads(&b).unwrap();
        ...
        // File
        let fname = "serialization/test_boundingbox.bin";
        bb.pb_dump(fname);
        let loaded = BoundingBox::pb_load(fname);
...
REGISTER_MINI_TEST!("BoundingBox", "Constructor", crate::boundingbox_test::run_boundingbox_constructor);
REGISTER_MINI_TEST!("BoundingBox", "Collision", crate::boundingbox_test::run_boundingbox_collision);
REGISTER_MINI_TEST!("BoundingBox", "Transformation", crate::boundingbox_test::run_boundingbox_transformation);
REGISTER_MINI_TEST!("BoundingBox", "Json Roundtrip", crate::boundingbox_test::run_boundingbox_json_roundtrip);
REGISTER_MINI_TEST!("BoundingBox", "Protobuf Roundtrip", crate::boundingbox_test::run_boundingbox_protobuf_roundtrip);
