...
pub fn get_all_tests() -> Vec<RegisteredTest> {
    ...
    let tests = vec![
        ...
        RegisteredTest { group: "BRep", name: "Is Closed", func: run_brep_is_closed },
        RegisteredTest { group: "BRep", name: "Wire Edges", func: run_brep_wire_edges },
        RegisteredTest { group: "BRep", name: "Edge Faces", func: run_brep_edge_faces },
        RegisteredTest { group: "BRep", name: "Update Tolerances", func: run_brep_update_tolerances },
        ...
        RegisteredTest { group: "BRep", name: "Create Pyramid", func: run_brep_create_pyramid },
