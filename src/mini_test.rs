...
pub fn get_all_tests() -> Vec<RegisteredTest> {
    ...
    let mut tests = vec![
        ...
        RegisteredTest { group: "BRep", name: "Volume", func: run_brep_volume },
        RegisteredTest { group: "BRep", name: "Contains Point", func: run_brep_contains_point },
        RegisteredTest { group: "BRep", name: "Boolean Example brep_booleans", func: run_brep_boolean_box_cyl },
        RegisteredTest { group: "BRep", name: "Boolean Off-Center Cyl", func: run_brep_boolean_offcenter_cyl },
        RegisteredTest { group: "BRep", name: "Boolean Contained Box", func: run_brep_boolean_contained_box },
        RegisteredTest { group: "BRep", name: "Boolean Box-Box", func: run_brep_boolean_box_box },
        RegisteredTest { group: "BRep", name: "Boolean Contained Sphere", func: run_brep_boolean_contained_sphere },
        RegisteredTest { group: "BRep", name: "Block With Hole Volume", func: run_brep_block_with_hole_volume },
        RegisteredTest { group: "BRep", name: "Boolean Sphere Split", func: run_brep_boolean_sphere_split },
        RegisteredTest { group: "BRep", name: "Transform Roundtrip", func: run_brep_transform_roundtrip },
        RegisteredTest { group: "BRep", name: "Create Cone", func: run_brep_create_cone },
        RegisteredTest { group: "BRep", name: "Create Torus", func: run_brep_create_torus },
        RegisteredTest { group: "BRep", name: "Create Block With Hole", func: run_brep_create_block_with_hole },
        RegisteredTest { group: "BRep", name: "Mesh Orientation", func: run_brep_mesh_orientation },
        RegisteredTest { group: "BRep", name: "Split By Plane", func: run_brep_split_by_plane },
        RegisteredTest { group: "BRep", name: "Split By Plane Pieces", func: run_brep_split_by_plane_pieces },
        RegisteredTest { group: "BRep", name: "Split By Line", func: run_brep_split_by_line },
        RegisteredTest { group: "BRep", name: "Split By Brep", func: run_brep_split_by_brep },
        // Color tests
        ...
        RegisteredTest { group: "Point", name: "Dihedral Angle Deg", func: run_point_dihedral_angle_deg },
        // Vector tests
        ...
        RegisteredTest { group: "Vector", name: "Transformation", func: run_vector_transformation },
        RegisteredTest { group: "Vector", name: "Scale", func: run_vector_scale },
        RegisteredTest { group: "Vector", name: "Reflect", func: run_vector_reflect },
        RegisteredTest { group: "Vector", name: "Average Normal", func: run_vector_average_normal },
        RegisteredTest { group: "Vector", name: "Interpolate Points", func: run_vector_interpolate_points },
        // Tolerance tests
        ...
        RegisteredTest { group: "Tolerance", name: "To Radians", func: run_tolerance_to_radians },
        RegisteredTest { group: "Tolerance", name: "To Degrees", func: run_tolerance_to_degrees },
        RegisteredTest { group: "Tolerance", name: "Unique From Two Int", func: run_tolerance_unique_from_two_int },
        RegisteredTest { group: "Tolerance", name: "Wrap Index", func: run_tolerance_wrap_index },
        RegisteredTest { group: "Tolerance", name: "Triangle Edge By Angle", func: run_tolerance_triangle_edge_by_angle },
        RegisteredTest { group: "Tolerance", name: "Rad Deg Conversion", func: run_tolerance_rad_deg },
        RegisteredTest { group: "Tolerance", name: "Count Digits", func: run_tolerance_count_digits },
        RegisteredTest { group: "Tolerance", name: "Is Angle Zero", func: run_tolerance_is_angle_zero },
        RegisteredTest { group: "Tolerance", name: "Is Angles Close", func: run_tolerance_is_angles_close },
        RegisteredTest { group: "Tolerance", name: "Is Point Close", func: run_tolerance_is_point_close },
        RegisteredTest { group: "Tolerance", name: "Is Allclose", func: run_tolerance_is_allclose },
        RegisteredTest { group: "Tolerance", name: "Key Xy", func: run_tolerance_key_xy },
        RegisteredTest { group: "Tolerance", name: "Round To", func: run_tolerance_round_to },
        RegisteredTest { group: "Tolerance", name: "Precision From Tolerance", func: run_tolerance_precision_from_tolerance },
        RegisteredTest { group: "Tolerance", name: "Tolerance", func: run_tolerance_tolerance },
        RegisteredTest { group: "Tolerance", name: "Compare", func: run_tolerance_compare },
        RegisteredTest { group: "Tolerance", name: "Is Finite", func: run_tolerance_is_finite },
        RegisteredTest { group: "Tolerance", name: "Is Vector Close", func: run_tolerance_is_vector_close },
        RegisteredTest { group: "Tolerance", name: "Temporary", func: run_tolerance_temporary },
        // Line tests
        ...
        RegisteredTest { group: "Line", name: "Overlap", func: run_line_overlap },
        RegisteredTest { group: "Line", name: "Overlap Average", func: run_line_overlap_average },
        RegisteredTest { group: "Line", name: "Extend", func: run_line_extend },
        // Polyline tests
        ...
        RegisteredTest { group: "Polyline", name: "Line Line Overlap Average", func: run_polyline_line_line_overlap_average },
        RegisteredTest { group: "Polyline", name: "Line From Projected Points", func: run_polyline_line_from_projected_points },
        RegisteredTest { group: "Polyline", name: "Point In Polygon 2d", func: run_polyline_point_in_polygon_2d },
        RegisteredTest { group: "Polyline", name: "Extend Line Segment", func: run_polyline_extend_line_segment },
        RegisteredTest { group: "Polyline", name: "Shrink Line Segment", func: run_polyline_shrink_line_segment },
        RegisteredTest { group: "Polyline", name: "Add Point", func: run_polyline_add_point },
        RegisteredTest { group: "Polyline", name: "Insert Point", func: run_polyline_insert_point },
        RegisteredTest { group: "Polyline", name: "Remove Point", func: run_polyline_remove_point },
        RegisteredTest { group: "Polyline", name: "Closed", func: run_polyline_closed },
        RegisteredTest { group: "Polyline", name: "Get Lines", func: run_polyline_get_lines },
        RegisteredTest { group: "Polyline", name: "Interpolate Points", func: run_polyline_interpolate_points },
        RegisteredTest { group: "Polyline", name: "Quick Hull", func: run_polyline_quick_hull },
        RegisteredTest { group: "Polyline", name: "Bounding Rectangle", func: run_polyline_bounding_rectangle },
        RegisteredTest { group: "Polyline", name: "Grid Of Points In Polygon", func: run_polyline_grid_of_points },
        RegisteredTest { group: "Polyline", name: "Polylabel", func: run_polyline_polylabel },
        RegisteredTest { group: "Polyline", name: "Polylabel Circle Division Points", func: run_polyline_polylabel_circle_division_points },
        RegisteredTest { group: "Polyline", name: "Boolean Op", func: run_polyline_boolean_op },
        RegisteredTest { group: "Polyline", name: "Boolean Op Plane", func: run_polyline_boolean_op_plane },
        RegisteredTest { group: "Polyline", name: "Merge Collinear", func: run_polyline_merge_collinear },
        RegisteredTest { group: "Polyline", name: "Simplify Points", func: run_polyline_simplify_points },
        RegisteredTest { group: "Polyline", name: "Simplify", func: run_polyline_simplify },
        RegisteredTest { group: "Polyline", name: "Simplify Collinear", func: run_polyline_simplify_collinear },
        RegisteredTest { group: "Polyline", name: "Simplify Zigzag", func: run_polyline_simplify_zigzag },
        RegisteredTest { group: "Polyline", name: "Simplify Two Points", func: run_polyline_simplify_two_points },
        RegisteredTest { group: "Polyline", name: "Translate", func: run_polyline_translate },
        RegisteredTest { group: "Polyline", name: "Extend Edge Equally", func: run_polyline_extend_edge_equally },
        // Plane tests
        ...
        RegisteredTest { group: "Plane", name: "Is Valid", func: run_plane_is_valid },
        RegisteredTest { group: "Plane", name: "Is Same Direction", func: run_plane_is_same_direction },
        RegisteredTest { group: "Plane", name: "Is Same Position", func: run_plane_is_same_position },
        RegisteredTest { group: "Plane", name: "Translate By Normal", func: run_plane_translate_by_normal },
        RegisteredTest { group: "Plane", name: "Base1 Base2", func: run_plane_base1_base2 },
        RegisteredTest { group: "Plane", name: "Transformed", func: run_plane_transformed },
        RegisteredTest { group: "Plane", name: "Has On Negative Side", func: run_plane_has_on_negative_side },
        // PointCloud tests
        ...
        RegisteredTest { group: "PointCloud", name: "Point Count", func: run_pointcloud_point_count },
        RegisteredTest { group: "PointCloud", name: "Len", func: run_pointcloud_len },
        RegisteredTest { group: "PointCloud", name: "Is Empty", func: run_pointcloud_is_empty },
        RegisteredTest { group: "PointCloud", name: "Get Point", func: run_pointcloud_get_point },
        RegisteredTest { group: "PointCloud", name: "Set Point", func: run_pointcloud_set_point },
        RegisteredTest { group: "PointCloud", name: "Add Point", func: run_pointcloud_add_point },
        RegisteredTest { group: "PointCloud", name: "Get Points", func: run_pointcloud_get_points },
        RegisteredTest { group: "PointCloud", name: "Color Count", func: run_pointcloud_color_count },
        RegisteredTest { group: "PointCloud", name: "Get Color", func: run_pointcloud_get_color },
        RegisteredTest { group: "PointCloud", name: "Set Color", func: run_pointcloud_set_color },
        RegisteredTest { group: "PointCloud", name: "Add Color", func: run_pointcloud_add_color },
        RegisteredTest { group: "PointCloud", name: "Get Colors", func: run_pointcloud_get_colors },
        RegisteredTest { group: "PointCloud", name: "Normal Count", func: run_pointcloud_normal_count },
        RegisteredTest { group: "PointCloud", name: "Get Normal", func: run_pointcloud_get_normal },
        RegisteredTest { group: "PointCloud", name: "Set Normal", func: run_pointcloud_set_normal },
        RegisteredTest { group: "PointCloud", name: "Add Normal", func: run_pointcloud_add_normal },
        RegisteredTest { group: "PointCloud", name: "Get Normals", func: run_pointcloud_get_normals },
        RegisteredTest { group: "PointCloud", name: "Transformed", func: run_pointcloud_transformed },
        // Xform tests
        ...
        RegisteredTest { group: "Xform", name: "Rotation X", func: run_xform_rotation_x },
        RegisteredTest { group: "Xform", name: "Rotation Y", func: run_xform_rotation_y },
        RegisteredTest { group: "Xform", name: "Rotation Z", func: run_xform_rotation_z },
        RegisteredTest { group: "Xform", name: "Rotation Axis", func: run_xform_rotation_axis },
        RegisteredTest { group: "Xform", name: "Rotation Around Line", func: run_xform_rotation_around_line },
        ...
        RegisteredTest { group: "Xform", name: "Scale XYZ", func: run_xform_scale_xyz },
        RegisteredTest { group: "Xform", name: "Scale Uniform", func: run_xform_scale_uniform },
        RegisteredTest { group: "Xform", name: "Scale Non Uniform", func: run_xform_scale_non_uniform },
        RegisteredTest { group: "Xform", name: "Look At Right Handed", func: run_xform_look_at_right_handed },
        RegisteredTest { group: "Xform", name: "Look To Right Handed", func: run_xform_look_to_right_handed },
        RegisteredTest { group: "Xform", name: "Perspective", func: run_xform_perspective },
        RegisteredTest { group: "Xform", name: "Orthographic", func: run_xform_orthographic },
        RegisteredTest { group: "Xform", name: "Project To Plane", func: run_xform_project_to_plane },
        RegisteredTest { group: "Xform", name: "Project To Plane By Axis", func: run_xform_project_to_plane_by_axis },
        ...
        RegisteredTest { group: "Xform", name: "Transform Point", func: run_xform_transform_point },
        RegisteredTest { group: "Xform", name: "Transform Vector", func: run_xform_transform_vector },
        RegisteredTest { group: "Xform", name: "To Cols", func: run_xform_to_cols },
        RegisteredTest { group: "Xform", name: "From Change Of Basis", func: run_xform_from_change_of_basis },
        // Mesh tests
        ...
        RegisteredTest { group: "Mesh", name: "Loft with quads and triangles", func: run_mesh_loft_panels },
        RegisteredTest { group: "Mesh", name: "Edges", func: run_mesh_edges },
        RegisteredTest { group: "Mesh", name: "Loft plate_failing 15-vert outer + 3 holes", func: run_mesh_loft_plate_failing },
        RegisteredTest { group: "Mesh", name: "Loft plate_v2 15-vert outer + 3 holes", func: run_mesh_loft_plate_v2 },
        RegisteredTest { group: "Mesh", name: "Refresh Guid", func: run_mesh_refresh_guid },
        // NurbsCurve tests
        ...
        RegisteredTest { group: "NurbsCurve", name: "Create From Parameters", func: run_nurbscurve_create_from_parameters },
        RegisteredTest { group: "NurbsCurve", name: "Create Fitted", func: run_nurbscurve_create_fitted },
        RegisteredTest { group: "NurbsCurve", name: "Curvature", func: run_nurbscurve_curvature },
        RegisteredTest { group: "NurbsCurve", name: "Join", func: run_nurbscurve_join },
        // NurbsSurface tests
        RegisteredTest { group: "NurbsSurface", name: "Constructor", func: run_nurbssurface_constructor },
        RegisteredTest { group: "NurbsSurface", name: "Create From Parameters", func: run_nurbssurface_create_from_parameters },
        ...
        RegisteredTest { group: "NurbsSurface", name: "ClosestPoint", func: run_nurbssurface_closest_point },
        RegisteredTest { group: "NurbsSurface", name: "Split By Plane", func: run_nurbssurface_split_by_plane },
        RegisteredTest { group: "NurbsSurface", name: "Split By Curves", func: run_nurbssurface_split_by_curves },
        RegisteredTest { group: "NurbsSurface", name: "Split By Line", func: run_nurbssurface_split_by_line },
        RegisteredTest { group: "NurbsSurface", name: "Split By Surface", func: run_nurbssurface_split_by_surface },
        RegisteredTest { group: "NurbsSurface", name: "Split By Brep", func: run_nurbssurface_split_by_brep },
        // NurbsKnot tests
        ...
        RegisteredTest { group: "NurbsSurfaceTrimmed", name: "Split By UV Curves", func: run_nurbssurface_trimmed_split_by_uv_curves },
        // Closest tests
        ...
        RegisteredTest { group: "Closest", name: "Surface Curve", func: run_closest_surface_curve },
        RegisteredTest { group: "Closest", name: "Pointcloud Point SpatialKDTree", func: run_closest_pointcloud_point_kdtree },
        RegisteredTest { group: "Closest", name: "Lines Closest", func: run_closest_lines_closest },
        RegisteredTest { group: "Closest", name: "Polylines Closest", func: run_closest_polylines_closest },
        RegisteredTest { group: "Closest", name: "Nurbscurves Closest", func: run_closest_nurbscurves_closest },
        RegisteredTest { group: "Closest", name: "Boxes Closest", func: run_closest_boxes_closest },
        // Primitives tests
        ...
        RegisteredTest { group: "Primitives", name: "Mesh Edge Pipes", func: run_primitives_mesh_edge_pipes },
        // Intersection tests
        ...
        RegisteredTest { group: "Intersection", name: "Surface Plane UV", func: run_intersection_surface_plane_uv },
        RegisteredTest { group: "Intersection", name: "Surface Surface", func: run_intersection_surface_surface },
        RegisteredTest { group: "Intersection", name: "Surface Surface Accuracy", func: run_intersection_surface_surface_accuracy },
        RegisteredTest { group: "Intersection", name: "Remap", func: run_intersection_remap },
        RegisteredTest { group: "Intersection", name: "Closest Point On Segment", func: run_intersection_closest_point_on_segment },
        RegisteredTest { group: "Intersection", name: "Plane Plane Plane Check Parallel", func: run_intersection_plane_plane_plane_check_parallel },
        RegisteredTest { group: "Intersection", name: "Plane 4 Planes Closed", func: run_intersection_plane_4planes },
        RegisteredTest { group: "Intersection", name: "Plane 4 Planes Open", func: run_intersection_plane_4planes_open },
        RegisteredTest { group: "Intersection", name: "Plane 4 Lines", func: run_intersection_plane_4lines },
        RegisteredTest { group: "Intersection", name: "Scale Vector To Distance Of 2 Planes", func: run_intersection_scale_vector_to_distance_of_2planes },
        RegisteredTest { group: "Intersection", name: "Polyline Plane", func: run_intersection_polyline_plane },
        RegisteredTest { group: "Intersection", name: "Line Line 3D", func: run_intersection_line_line_3d },
        RegisteredTest { group: "Intersection", name: "Polyline Plane To Line", func: run_intersection_polyline_plane_to_line },
        RegisteredTest { group: "Intersection", name: "Quad From Line Top Bottom Planes", func: run_intersection_quad_from_line_top_bottom_planes },
        RegisteredTest { group: "Intersection", name: "Orthogonal Vector Between Two Plane Pairs", func: run_intersection_orthogonal_vector_between_two_plane_pairs },
        RegisteredTest { group: "Intersection", name: "Closed And Open Paths 2D", func: run_intersection_closed_and_open_paths_2d },
        RegisteredTest { group: "Intersection", name: "Line Line Classified", func: run_intersection_line_line_classified },
        // Session tests
        ...
        RegisteredTest { group: "Session", name: "Add Group", func: run_session_add_group },
        RegisteredTest { group: "Session", name: "Add Edge", func: run_session_add_edge },
        RegisteredTest { group: "Session", name: "Add Hierarchy", func: run_session_add_hierarchy },
        RegisteredTest { group: "Session", name: "Get Children", func: run_session_get_children },
        RegisteredTest { group: "Session", name: "Add Relationship", func: run_session_add_relationship },
        RegisteredTest { group: "Session", name: "Get Neighbours", func: run_session_get_neighbours },
        ...
        RegisteredTest { group: "Session", name: "Add OBB", func: run_session_add_obb },
        RegisteredTest { group: "Session", name: "Add Nurbscurve", func: run_session_add_nurbscurve },
        RegisteredTest { group: "Session", name: "Add Nurbssurface", func: run_session_add_nurbssurface },
        RegisteredTest { group: "Session", name: "Add Brep", func: run_session_add_brep },
        RegisteredTest { group: "Session", name: "Get Collisions", func: run_session_get_collisions },
        RegisteredTest { group: "Session", name: "Ray Cast", func: run_session_ray_cast },
        RegisteredTest { group: "Session", name: "Lookup Mutation Roundtrip", func: run_session_lookup_mutation_roundtrip },
        RegisteredTest { group: "Session", name: "Order", func: run_session_order },
        RegisteredTest { group: "Session", name: "Add Component", func: run_session_add_component },
        RegisteredTest { group: "Session", name: "Component Json Roundtrip", func: run_session_component_json_roundtrip },
        // SessionConfig tests
        ...
        RegisteredTest { group: "FileObj", name: "String Roundtrip", func: run_file_obj_string_roundtrip },
        // RemeshCDT tests
        ...
        RegisteredTest { group: "Quaternion", name: "Constructor", func: run_quaternion_constructor },
        RegisteredTest { group: "Quaternion", name: "Identity", func: run_quaternion_identity },
        RegisteredTest { group: "Quaternion", name: "From Components", func: run_quaternion_from_components },
        RegisteredTest { group: "Quaternion", name: "From Axis Angle", func: run_quaternion_from_axis_angle },
        RegisteredTest { group: "Quaternion", name: "From Arc", func: run_quaternion_from_arc },
        RegisteredTest { group: "Quaternion", name: "From Euler", func: run_quaternion_from_euler },
        RegisteredTest { group: "Quaternion", name: "From Rotation", func: run_quaternion_from_rotation },
        RegisteredTest { group: "Quaternion", name: "Rotate Vector", func: run_quaternion_rotate_vector },
        RegisteredTest { group: "Quaternion", name: "Get Rotation", func: run_quaternion_get_rotation },
        RegisteredTest { group: "Quaternion", name: "Magnitude", func: run_quaternion_magnitude },
        RegisteredTest { group: "Quaternion", name: "Magnitude Squared", func: run_quaternion_magnitude_squared },
        RegisteredTest { group: "Quaternion", name: "Normalized", func: run_quaternion_normalized },
        RegisteredTest { group: "Quaternion", name: "Conjugate", func: run_quaternion_conjugate },
        RegisteredTest { group: "Quaternion", name: "Invert", func: run_quaternion_invert },
        RegisteredTest { group: "Quaternion", name: "Dot", func: run_quaternion_dot },
        RegisteredTest { group: "Quaternion", name: "Slerp", func: run_quaternion_slerp },
        RegisteredTest { group: "Quaternion", name: "Nlerp", func: run_quaternion_nlerp },
        RegisteredTest { group: "Quaternion", name: "Protobuf Roundtrip", func: run_quaternion_protobuf_roundtrip },
        // OBB tests
        ...
        RegisteredTest { group: "OBB", name: "Accessors", func: run_obb_accessors },
        RegisteredTest { group: "OBB", name: "From Geometry", func: run_obb_from_geometry },
        RegisteredTest { group: "OBB", name: "From Plane", func: run_obb_from_plane },
        RegisteredTest { group: "OBB", name: "Two Rectangles", func: run_obb_two_rectangles },
        // Edge tests
        RegisteredTest { group: "Edge", name: "Json Roundtrip", func: run_edge_json_roundtrip },
        RegisteredTest { group: "Edge", name: "Constructor", func: run_edge_constructor },
        RegisteredTest { group: "Edge", name: "Vertices", func: run_edge_vertices },
        RegisteredTest { group: "Edge", name: "Connects", func: run_edge_connects },
        RegisteredTest { group: "Edge", name: "Other Vertex", func: run_edge_other_vertex },
        // Graph tests
        RegisteredTest { group: "Graph", name: "Json Roundtrip", func: run_graph_json_roundtrip },
        RegisteredTest { group: "Graph", name: "Constructor", func: run_graph_constructor },
        ...
        RegisteredTest { group: "Graph", name: "Remove Edge", func: run_graph_remove_edge },
        RegisteredTest { group: "Graph", name: "Get Vertices", func: run_graph_get_vertices },
        RegisteredTest { group: "Graph", name: "Get Edges", func: run_graph_get_edges },
        RegisteredTest { group: "Graph", name: "Neighbors", func: run_graph_neighbors },
        RegisteredTest { group: "Graph", name: "Get Neighbors", func: run_graph_get_neighbors },
        RegisteredTest { group: "Graph", name: "Number Of Vertices", func: run_graph_number_of_vertices },
        RegisteredTest { group: "Graph", name: "Number Of Edges", func: run_graph_number_of_edges },
        RegisteredTest { group: "Graph", name: "Clear", func: run_graph_clear },
        RegisteredTest { group: "Graph", name: "Node Attribute", func: run_graph_node_attribute },
        RegisteredTest { group: "Graph", name: "Edge Attribute", func: run_graph_edge_attribute },
        RegisteredTest { group: "Graph", name: "Bfs", func: run_graph_bfs },
        RegisteredTest { group: "Graph", name: "Dfs", func: run_graph_dfs },
        RegisteredTest { group: "Graph", name: "Connected Components", func: run_graph_connected_components },
        RegisteredTest { group: "Graph", name: "Shortest Path", func: run_graph_shortest_path },
        RegisteredTest { group: "Graph", name: "Has Cycle", func: run_graph_has_cycle },
        RegisteredTest { group: "Graph", name: "Cycle Basis", func: run_graph_cycle_basis },
        // Objects tests
        RegisteredTest { group: "Objects", name: "Json Roundtrip", func: run_objects_json_roundtrip },
        RegisteredTest { group: "Objects", name: "Constructor", func: run_objects_constructor },
        RegisteredTest { group: "Objects", name: "Protobuf Roundtrip", func: run_objects_protobuf_roundtrip },
        RegisteredTest { group: "Objects", name: "Component Constructor", func: run_objects_component_constructor },
        RegisteredTest { group: "Objects", name: "Component Json Roundtrip", func: run_objects_component_json_roundtrip },
        RegisteredTest { group: "Objects", name: "Component Protobuf Roundtrip", func: run_objects_component_protobuf_roundtrip },
        // Tree tests
        RegisteredTest { group: "Tree", name: "Json Roundtrip", func: run_tree_json_roundtrip },
        RegisteredTest { group: "Tree", name: "Constructor", func: run_tree_constructor },
        RegisteredTest { group: "Tree", name: "Protobuf Roundtrip", func: run_tree_protobuf_roundtrip },
        RegisteredTest { group: "Tree", name: "Root", func: run_tree_root },
        RegisteredTest { group: "Tree", name: "Add", func: run_tree_add },
        RegisteredTest { group: "Tree", name: "Nodes", func: run_tree_nodes },
        RegisteredTest { group: "Tree", name: "Remove", func: run_tree_remove },
        RegisteredTest { group: "Tree", name: "Leaves", func: run_tree_leaves },
        RegisteredTest { group: "Tree", name: "Traverse", func: run_tree_traverse },
        RegisteredTest { group: "Tree", name: "Get Node By Name", func: run_tree_get_node_by_name },
        RegisteredTest { group: "Tree", name: "Get Nodes By Name", func: run_tree_get_nodes_by_name },
        RegisteredTest { group: "Tree", name: "Find Node By Guid", func: run_tree_find_node_by_guid },
        RegisteredTest { group: "Tree", name: "Add Child By Guid", func: run_tree_add_child_by_guid },
        RegisteredTest { group: "Tree", name: "Get Children Guids", func: run_tree_get_children_guids },
        // TreeNode tests
        RegisteredTest { group: "TreeNode", name: "Json Roundtrip", func: run_treenode_json_roundtrip },
        RegisteredTest { group: "TreeNode", name: "Constructor", func: run_treenode_constructor },
        RegisteredTest { group: "TreeNode", name: "Is Root", func: run_treenode_is_root },
        RegisteredTest { group: "TreeNode", name: "Is Leaf", func: run_treenode_is_leaf },
        RegisteredTest { group: "TreeNode", name: "Tree", func: run_treenode_tree },
        RegisteredTest { group: "TreeNode", name: "Add", func: run_treenode_add },
        RegisteredTest { group: "TreeNode", name: "Remove", func: run_treenode_remove },
        RegisteredTest { group: "TreeNode", name: "Parent", func: run_treenode_parent },
        RegisteredTest { group: "TreeNode", name: "Ancestors", func: run_treenode_ancestors },
        RegisteredTest { group: "TreeNode", name: "Descendants", func: run_treenode_descendants },
        RegisteredTest { group: "TreeNode", name: "Children", func: run_treenode_children },
        RegisteredTest { group: "TreeNode", name: "Traverse", func: run_treenode_traverse },
        // Vertex tests
        RegisteredTest { group: "Vertex", name: "Json Roundtrip", func: run_vertex_json_roundtrip },
        RegisteredTest { group: "Vertex", name: "Constructor", func: run_vertex_constructor },
        // Encoders tests
        ...
        RegisteredTest { group: "SpatialAABBTree", name: "Constructor", func: run_spatial_aabbtree_constructor },
        RegisteredTest { group: "SpatialAABBTree", name: "Query Aabb", func: run_spatial_aabbtree_query_aabb },
        ...
        RegisteredTest { group: "RemeshNurbsSurfaceGrid", name: "Double-Curved Triangle", func: run_remesh_nurbssurface_grid_double_curved_triangle },
        // SpatialRTree tests
        ...
        RegisteredTest { group: "SpatialRTree", name: "Constructor", func: run_rtree_constructor },
        // Element tests
        ...
        RegisteredTest { group: "Element", name: "Brep Aabb", func: run_element_brep_aabb },
        ...
        RegisteredTest { group: "ElementFeature", name: "Json Roundtrip", func: run_element_feature_json_roundtrip },
        RegisteredTest { group: "ElementFeature", name: "Protobuf Roundtrip", func: run_element_feature_protobuf_roundtrip },
        ...
        // AABB tests
        RegisteredTest { group: "AABB", name: "Constructor", func: run_aabb_constructor },
        RegisteredTest { group: "AABB", name: "From Geometry", func: run_aabb_from_geometry },
        // Boolean Polyline tests
        RegisteredTest { group: "Boolean Polyline", name: "Overlapping Squares", func: run_boolean_polyline_overlapping_squares },
        RegisteredTest { group: "Boolean Polyline", name: "Circle Vs Rectangle", func: run_boolean_polyline_circle_vs_rectangle },
        RegisteredTest { group: "Boolean Polyline", name: "Star Vs Circle", func: run_boolean_polyline_star_vs_circle },
        RegisteredTest { group: "Boolean Polyline", name: "L Shape Vs Rectangle", func: run_boolean_polyline_l_shape_vs_rectangle },
        RegisteredTest { group: "Boolean Polyline", name: "Two Large Circles", func: run_boolean_polyline_two_large_circles },
        RegisteredTest { group: "Boolean Polyline", name: "Diamond Vs Triangle", func: run_boolean_polyline_diamond_vs_triangle },
        RegisteredTest { group: "Boolean Polyline", name: "Star Vs Star", func: run_boolean_polyline_star_vs_star },
        RegisteredTest { group: "Boolean Polyline", name: "Cross Shape", func: run_boolean_polyline_cross_shape },
        RegisteredTest { group: "Boolean Polyline", name: "Concave Arrow Vs Circle", func: run_boolean_polyline_concave_arrow_vs_circle },
        RegisteredTest { group: "Boolean Polyline", name: "Two Large Circles 1000", func: run_boolean_polyline_two_large_circles_1000 },
        RegisteredTest { group: "Boolean Polyline", name: "Large Coords Auto Scale", func: run_boolean_polyline_large_coords_auto_scale },
        // Boolean Polyline Open tests
        RegisteredTest { group: "Boolean Polyline Open", name: "Horizontal Line Vs Unit Square", func: run_boolean_polyline_open_horizontal_line_vs_unit_square },
        RegisteredTest { group: "Boolean Polyline Open", name: "Diagonal Line Vs Unit Square", func: run_boolean_polyline_open_diagonal_line_vs_unit_square },
        RegisteredTest { group: "Boolean Polyline Open", name: "Interior Open Path Passes Through", func: run_boolean_polyline_open_interior_open_path_passes_through },
        // ConvexHull tests
        RegisteredTest { group: "ConvexHull", name: "Hull 2d", func: run_convex_hull_hull_2d },
        RegisteredTest { group: "ConvexHull", name: "Hull 2d Collinear", func: run_convex_hull_hull_2d_collinear },
        RegisteredTest { group: "ConvexHull", name: "Hull 2d Circle", func: run_convex_hull_hull_2d_circle },
        RegisteredTest { group: "ConvexHull", name: "Hull 3d", func: run_convex_hull_hull_3d },
        RegisteredTest { group: "ConvexHull", name: "Hull 3d Cube", func: run_convex_hull_hull_3d_cube },
        // InstanceRef tests
        RegisteredTest { group: "InstanceRef", name: "Constructor", func: run_instance_ref_constructor },
        RegisteredTest { group: "InstanceRef", name: "Transformation", func: run_instance_ref_transformation },
        RegisteredTest { group: "InstanceRef", name: "Json Roundtrip", func: run_instance_ref_json_roundtrip },
        RegisteredTest { group: "InstanceRef", name: "Protobuf Roundtrip", func: run_instance_ref_protobuf_roundtrip },
        // Io tests
        RegisteredTest { group: "Io", name: "Read Bunny", func: run_io_read_bunny },
        RegisteredTest { group: "Io", name: "String Roundtrip", func: run_io_string_roundtrip },
        RegisteredTest { group: "Io", name: "Write Read Roundtrip", func: run_io_write_read_roundtrip },
        RegisteredTest { group: "Io", name: "Read Colors", func: run_io_read_colors },
        // Matrix tests
        RegisteredTest { group: "Matrix", name: "Constructor", func: run_matrix_constructor },
        RegisteredTest { group: "Matrix", name: "Properties", func: run_matrix_properties },
        RegisteredTest { group: "Matrix", name: "Add", func: run_matrix_add },
        RegisteredTest { group: "Matrix", name: "Subtract", func: run_matrix_subtract },
        RegisteredTest { group: "Matrix", name: "Scale", func: run_matrix_scale },
        RegisteredTest { group: "Matrix", name: "Multiply", func: run_matrix_multiply },
        RegisteredTest { group: "Matrix", name: "Transpose", func: run_matrix_transpose },
        RegisteredTest { group: "Matrix", name: "Determinant", func: run_matrix_determinant },
        RegisteredTest { group: "Matrix", name: "Inverse", func: run_matrix_inverse },
        RegisteredTest { group: "Matrix", name: "Solve", func: run_matrix_solve },
        RegisteredTest { group: "Matrix", name: "Lu Decompose", func: run_matrix_lu_decompose },
        RegisteredTest { group: "Matrix", name: "Qr Decompose", func: run_matrix_qr_decompose },
        RegisteredTest { group: "Matrix", name: "Cholesky", func: run_matrix_cholesky },
        RegisteredTest { group: "Matrix", name: "Eigenvalues", func: run_matrix_eigenvalues },
        RegisteredTest { group: "Matrix", name: "Svd", func: run_matrix_svd },
        RegisteredTest { group: "Matrix", name: "Norms", func: run_matrix_norms },
        RegisteredTest { group: "Matrix", name: "Rank", func: run_matrix_rank },
        RegisteredTest { group: "Matrix", name: "Json Roundtrip", func: run_matrix_json_roundtrip },
        RegisteredTest { group: "Matrix", name: "Protobuf Roundtrip", func: run_matrix_protobuf_roundtrip },
        // SpatialKDTree tests
        RegisteredTest { group: "SpatialKDTree", name: "Constructor", func: run_kdtree_constructor },
